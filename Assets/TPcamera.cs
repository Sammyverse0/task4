...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (cameraHolder == null)
        {
            ...
            // Move the actual camera to be a child of the holder
    ...
    void LateUpdate()
    {
        // Additional camera collision detection can be added here
        // This ensures the camera doesn't clip through walls
    }
}